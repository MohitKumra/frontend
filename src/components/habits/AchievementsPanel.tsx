            ...
            {preview.map((achievement, idx) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{
                    y: -3,
                    scale: achievement.isUnlocked ? 1.02 : 1,
                ...
                >
                  <div
                    ...
                    style={{
                      background: achievement.isUnlocked ? 'var(--color-surface-raised)' : 'var(--color-surface)',
                      border: achievement.isUnlocked ? `1px solid ${tierColor}30` : `1px dashed ${tierColor}40`,
                    }}
                  >
                    ...
                    <div className="relative">
                      <motion.div
                        ...
                        style={{
                          background: achievement.isUnlocked ? `${tierColor}20` : `${tierColor}12`,
                        }}
                    ...
                    <div className="relative">
                      <p
                        className={`text-[12px] font-bold leading-tight ${achievement.isUnlocked ? 'text-text-primary' : 'text-text-muted'}`}
                      >
                        {achievement.title}
                      </p>
