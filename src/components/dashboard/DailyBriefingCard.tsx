  ...
  return (
    <Card className="p-5 sm:p-6 overflow-hidden relative">
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at top right, color-mix(in srgb, var(--color-accent) 16%, transparent), transparent 40%)',
        }}
      />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          >
            ...
            <p className="text-xs text-text-secondary mt-1">
              {briefing.overload ? 'plan is heavy today' : 'load looks manageable'}
            </p>
          </div>
          <div
            className="rounded-2xl border p-4"
